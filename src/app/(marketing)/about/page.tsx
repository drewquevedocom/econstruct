...
export const metadata: Metadata = generatePageMetadata({
  ...
  description:
    "Meet the team behind eConstruct Homes. Building in Los Angeles since 2001, founded as econstruct in 2011, with 634 combined partner projects. CA Lic #964015.",
  path: "/about",
});
...
const milestones = [
  ...
  {
    year: "2026",
    title: "634 Combined Partner Projects",
    description:
      "The 634 count reflects our partners' combined project history: primarily commercial work before 2011, with econstruct focused on residential construction since 2011.",
  },
];
...
const stats = [
  { value: "634", label: "Partner Projects", icon: HardHat },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
            ...
            <AnimatedSection delay={0.15}>
              ...
              <div className="space-y-5 text-gray-600 text-[1.05rem] leading-relaxed">
                ...
                <p>
                  Today, with 634 combined partner projects and over two decades of hands-on field experience, econstruct is recognized as one of Los Angeles&apos; most trusted residential construction firms. Our mission has never changed: to build enduring homes of unmatched quality — and to do it with the honesty and discipline that our clients deserve.
                </p>
              </div>

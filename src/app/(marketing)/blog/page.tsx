        ...
        <section className="bg-secondary py-16 md:py-20">
          <Container>
            <div className="mb-10 max-w-3xl">
              <p className="text-xs font-bold uppercase tracking-[0.22em] text-accent-gold">
                Temporary Blog Review
              </p>
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-brand-dark md:text-4xl">
                Draft Articles Waiting On Final Approval
              </h2>
              <p className="mt-4 text-base leading-relaxed text-body-text">
                These are the temporary blog drafts currently under image review. Each card shows
                the hero image, the secondary social image, and a direct link to the full draft preview.
              </p>
            </div>
                  ...
                  <div className="mt-8 grid gap-6 lg:grid-cols-2">
                    ...
                    <div>
                      ...
                      <div className="overflow-hidden rounded-[1.5rem] border border-black/8 bg-secondary">
                        <Image
                          src={post.ogImage}
                          alt={`${post.title} secondary preview image`}
                          width={1200}
                          height={630}

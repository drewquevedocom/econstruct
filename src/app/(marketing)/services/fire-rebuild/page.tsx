...
const features = [
  {
    ...
    description:
      "Every rebuild meets or exceeds Wildland-Urban Interface fire safety codes Ã¢â‚¬â€ ember-resistant vents, non-combustible roofing, tempered glass, and fire-rated assemblies.",
  },
  {
    icon: Banknote,
  ...
  },
  {
    ...
    description:
      "Zone-compliant landscaping designed to protect your home while maintaining beauty Ã¢â‚¬â€ fire-resistant native plants, hardscaping, and proper vegetation management.",
  },
  {
    icon: Zap,
    title: "Smart Home Integration",
    description:
      "Rebuild smarter with integrated home automation Ã¢â‚¬â€ automated fire detection, smart irrigation for defensible space, whole-home generators, and EV-ready garages.",
  },
];
...
const processSteps = [
  ...
  },
  {
    ...
    description:
      "Architectural plans, structural engineering, and WUI compliance documentation. Rebuild as-was or redesign Ã¢â‚¬â€ your choice, our expertise.",
    icon: ClipboardCheck,
  },
  {
    step: "04",
  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle="WUI-compliant reconstruction for Palisades, Altadena, and Malibu homeowners. Insurance coordination, expedited permits, and expert craftsmanship Ã¢â‚¬â€ we bring you home."
        breadcrumbs={[
      ...
      <section className="py-24 md:py-32">
        <Container>
          <SectionHeader
            ...
            subtitle="When fire takes your home, you need a contractor who understands the unique challenges of fire reconstruction Ã¢â‚¬â€ from WUI codes to insurance gaps."
          />
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "We provide a detailed, line-item cost breakdown comparing your settlement to actual construction costs Ã¢â‚¬â€ before you commit to a builder.",
                  },
                  {
                    icon: Banknote,

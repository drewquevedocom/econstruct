...
export const metadata: Metadata = generatePageMetadata({
  ...
  description:
    "Everything you need to know about rebuilding after a wildfire in Los Angeles Ã¢â‚¬â€ insurance settlements, WUI zone requirements, permits, timelines, costs, and choosing the right contractor.",
...
export default function FireRebuildGuidePage() {
  return (
    <>
      ...
      <PageHero
        title="The Complete Guide to Fire Rebuilds in Los Angeles"
        subtitle="Everything homeowners need to know about rebuilding after a wildfire Ã¢â‚¬â€ from insurance and permits to timelines and costs. Written by a team with 25+ years of LA construction experience."
        breadcrumbs={[
            ...
            <div className="flex-1 max-w-3xl">
              ...
              <AnimatedSection>
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  Losing your home to wildfire is devastating. The path forward Ã¢â‚¬â€ navigating insurance, understanding new building codes, pulling permits, and actually rebuilding Ã¢â‚¬â€ can feel overwhelming. This guide is designed to give you a clear, honest roadmap based on our experience rebuilding dozens of homes across the Pacific Palisades, Malibu, Altadena, and throughout Los Angeles County.
                </p>
              ...
              <AnimatedSection>
                <section id="wui-zone-requirements" className="mb-16 scroll-mt-32">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    WUI stands for Wildland-Urban Interface Ã¢â‚¬â€ the zone where developed neighborhoods meet undeveloped wildland vegetation. Most of the areas devastated by recent Los Angeles wildfires fall within designated WUI zones, including Pacific Palisades, Malibu, portions of Brentwood, Altadena, and hillside communities throughout the county.
                  </p>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    When you rebuild in a WUI zone, your new home must comply with Chapter 7A of the California Building Code, which mandates fire-resistant construction methods and materials throughout the entire structure. This is not optional Ã¢â‚¬â€ it is a code requirement enforced through the permitting and inspection process.
                  </p>
                  <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4">
                    ...
                    <li><strong>Eaves and overhangs:</strong> Enclosed eaves with non-combustible materials. Open eaves Ã¢â‚¬â€ common in mid-century and ranch-style homes Ã¢â‚¬â€ are no longer permitted in WUI zones.</li>
                  </ul>
                  <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    At econstruct, we design and build WUI-compliant structures from the ground up. Our team understands every nuance of Chapter 7A, and we coordinate with landscape architects to ensure your defensible space plan is integrated into the overall site design Ã¢â‚¬â€ not treated as an afterthought.
                  </p>
                </section>
              </AnimatedSection>
              ...
              <AnimatedSection>
                <section id="permit-process" className="mb-16 scroll-mt-32">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    The permit process is where many fire rebuild projects stall. The Los Angeles Department of Building and Safety (LADBS) Ã¢â‚¬â€ or the county equivalent for unincorporated areas Ã¢â‚¬â€ must approve your plans before any construction can begin. Understanding this process, and having a team that can navigate it efficiently, will save you months.
                  </p>
                  <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4">
                  ...
                  <ol className="list-decimal list-inside space-y-3 text-gray-700 mb-4">
                    ...
                    <li><strong>Inspections during construction:</strong> LADBS conducts inspections at key milestones Ã¢â‚¬â€ foundation, framing, rough MEP, insulation, and final. Each must pass before proceeding to the next phase.</li>
                  </ol>
                  <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4">
                    How econstruct Expedites Permitting
                  </h3>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Our 25+ years of experience with LA permitting means we know exactly what plan checkers look for Ã¢â‚¬â€ and we address those items before submission. We maintain relationships with LADBS staff, use express plan check services, and pre-clear common WUI compliance questions before formal review. The result: our clients typically receive permits 3-4 months faster than the industry average.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    For fire rebuild clients, we also navigate any special expedited permitting programs that the city may implement after a major fire event. These programs are time-limited and require specific documentation Ã¢â‚¬â€ our team ensures you qualify and take advantage of every available acceleration.
                  </p>
                </section>
              </AnimatedSection>
              ...
              <AnimatedSection>
                <section id="choosing-contractor" className="mb-16 scroll-mt-32">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4">
                    ...
                    <li>Quotes that are dramatically lower than other bids Ã¢â‚¬â€ this almost always leads to change orders later.</li>
              ...
              <AnimatedSection>
                <section id="cost-breakdown" className="mb-16 scroll-mt-32">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4">
                    ...
                    <li><strong>Material selections:</strong> Imported Italian stone vs. domestic tile, custom steel windows vs. aluminum, solid walnut cabinetry vs. painted MDF Ã¢â‚¬â€ material choices can swing costs 30-50%.</li>
                    ...
                    <li><strong>Design changes during construction:</strong> Change orders are the single biggest cause of budget overruns. Thorough pre-construction planning Ã¢â‚¬â€ which econstruct emphasizes heavily Ã¢â‚¬â€ minimizes this risk.</li>
                  </ul>
                  <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4">

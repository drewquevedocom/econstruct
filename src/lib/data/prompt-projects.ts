...
const basePromptProjects: PromptProjectPage[] = [
  ...
  },
  {
    ...
    heroSubtitle: "A beautiful newly completed ADU project in Santa Monica, delivered with clean execution and premium finishes.",
    challenge: [
  ...
  },
  {
    ...
    shortTitle: "Pacific Palisades Fire Rebuild",
    ...
    gallery: [
      {
        src: "/projects/Palisades_-_Hero_Shot_202607071557.jpeg",
        alt: "Pacific Palisades WUI fire rebuild completed contemporary home front exterior at sunset with stucco and stone facade",
        caption: "Front elevation at sunset — non-combustible stucco and warm natural stone cladding, Class A metal roof, and fire-rated aluminum window systems meeting WUI Chapter 7A requirements.",
      },
      {
        src: "/projects/Palisades_-_Front_Exterior_202607071557.jpeg",
        alt: "Pacific Palisades fire rebuild contemporary home front exterior with defensible space landscaping and stone terrace",
        caption: "Street facade — two-story modern volume with stone terrace walls, drought-tolerant defensible space planting, and a wood pivot entry framed in fire-rated materials.",
      },
      {
        src: "/projects/Palisades_-_Drone_View_202607071557.jpeg",
        alt: "Aerial drone view of Pacific Palisades fire rebuild home with Pacific Ocean and Santa Monica Bay backdrop",
        caption: "Aerial view — the completed rebuild sited on the hillside with Santa Monica Bay and the Pacific Ocean stretching to the horizon behind it.",
      },
      {
        src: "/projects/Palisades_-_Coastline_View_202607071557.jpeg",
        alt: "Drone aerial panorama of Pacific Palisades rebuilt home showing full coastline view from Pacific Coast Highway to the Santa Monica Mountains",
        caption: "Coastline panorama — drone angle showing the full scope of the Pacific Coast from Pacific Coast Highway to the Santa Monica Mountains, framed by the rebuilt home.",
      },
      {
        src: "/projects/Palisades_-_Elevated_Sunset_View_202607071557.jpeg",
        alt: "Elevated sunset view of Pacific Palisades WUI compliant rebuilt home with ocean horizon and warm golden light",
        caption: "Elevated sunset view — the home's upper terrace and glass railings capture the Pacific horizon at golden hour, a view the original structure also commanded.",
      },
      {
        src: "/projects/Palisades_-_Low_Angle_Sunset_202607071557.jpeg",
        alt: "Low angle sunset photo of Pacific Palisades rebuilt home showing standing seam metal roof and large format windows against warm sky",
        caption: "Low angle — the dark standing seam metal roof and oversized aluminum windows read clearly at sunset against the California sky.",
      },
      {
        src: "/projects/Palisades_-_Architectural_Detail_202607071557.jpeg",
        alt: "Architectural detail of Pacific Palisades fire rebuilt home showing natural stone cladding and aluminum window framing",
        caption: "Material detail — natural travertine stone cladding and precision-fit aluminum window framing; both materials are fire-rated and non-combustible per CBC Chapter 7A.",
      },
      {
        src: "/projects/Palisades_-_Side_Profile_202607071557.jpeg",
        alt: "Side profile view of Pacific Palisades contemporary fire rebuild home showing two-story massing and glass deck railings",
        caption: "Side profile — two-story massing with glass deck guardrails on the upper level capturing the ocean view from every room on the west-facing elevation.",
      },
      {
        src: "/projects/Palisades_-_Rear_Horizon_View_202607071557.jpeg",
        alt: "Rear view of Pacific Palisades fire rebuild home showing hillside terracing and unobstructed Pacific Ocean horizon",
        caption: "Rear elevation — hillside terracing and stone retaining walls anchor the home to the slope, with the Pacific Ocean horizon unobstructed behind.",
      },
      {
        src: "/projects/Palisades_-_Street_Level_View_202607071557.jpeg",
        alt: "Street level view of completed Pacific Palisades fire rebuild showing contemporary facade and drought-tolerant landscaping",
        caption: "Street level — the completed rebuild reads as a confident contemporary design from the street, with mature drought-tolerant planting and a clean stone driveway.",
      },
    ],
    ...
    heroTitle: "Pacific Palisades Fire Rebuild — WUI-Compliant Contemporary Home with Ocean Views",
    heroSubtitle: "After the January 2025 Palisades Fire, econstruct rebuilt a hillside residence from the ground up — fully WUI-compliant, fully permitted, and delivered in 14 months.",
    challenge: [
    ...
    testimonial: {
      quote: "We lost everything in the fire. Frank and the econstruct team rebuilt our home to a standard we never could have imagined starting from zero. It's better than what we had — safer, more beautiful, and they kept us informed every single week. We're home.",

...
export const faqs: FAQ[] = [
  ...
  { category: "general", question: "How long has econstruct been in business?", answer: "Owner Frank Neimroozi has over 25 years of construction experience. econstruct has built and renovated over 340 projects across Los Angeles." },
  ...
  { category: "general", question: "What makes econstruct different from other contractors?", answer: "Three things: our 25+ years of specialized experience, our ability to expedite permits 3× faster than industry average, and Frank Neimroozi's direct involvement in every project. We're not a volume builder — we're craftsmen who happen to build at scale." },
  ...
  { category: "process", question: "Who will manage my project day-to-day?", answer: "Every project has a dedicated project manager. Frank Neimroozi personally oversees all projects and conducts regular site visits. You'll have direct communication with both your PM and Frank throughout the build." },
